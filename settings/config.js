module.exports = {
  ...
  process.env.REACT_APP_TOKEN ||
    "MTAzODExNjgyMjQxNjg5MTk2NQ.GKvasi.VQvcDDw3JIK_Ezm_qdMkrSNmAvROM1EUUH40cg",
  PREFIX: process.env.PREFIX || ",",
  embed: {
    color: process.env.color || "#220f80",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "Coded By Pewdsss",
    footericon: " ",
  },
  emoji: {
    ERROR: "❌",
  ...
  // others
  guildID: process.env.guildID || "790238604357009408", // for slash command
  ...
  links: {
    ...
    DiscordServer: process.env.DiscordServer || `hi`,
    VoteURL: process.env.VoteURL || `ok`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true
